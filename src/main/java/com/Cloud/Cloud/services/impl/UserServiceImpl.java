...
public class UserServiceImpl implements UserService {
    @Autowired
    private UserRepo userRepo; // database mein user ko save kr na layiya
    ...
    private Logger logger = LoggerFactory.getLogger(this.getClass()); // log ka liya
    ...
    public Optional<User> updateUser(User user) {
        ...
        // update user2 ko karinga user mein
